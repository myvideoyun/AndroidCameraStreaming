...
public class LiveStreamActivity extends AppCompatActivity implements MVYCameraPreviewListener, MVYAudioRecorderListener, MVYPreviewViewListener, MVYMediaCodecEncoderListener {

    private static final String TAG = "LiveStreamActivity";

    // 视频RTMP路径
    private static final String rtmpPath = "rtmp://";
...
//        openBackCamera();
    ...
    public void showVideo() {
        try {
            ...
            Uri contentUri = FileProvider.getUriForFile(getBaseContext(), "com.myvideoyun.livestream.fileprovider", new File(rtmpPath));
    ...
    private boolean startMediaCodec() {
        ...
        // 启动编码
        encoder = new MVYMediaCodecEncoder(rtmpPath);
