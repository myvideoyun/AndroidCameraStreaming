...
public class MVYAudioRecorderWrap {

    private MVYAudioRecorderListener audioRecorderListener;
    ...
    public MVYAudioRecorderWrap(AudioRecord audioRecord, int bufferSize) {
    ...
    public void setAudioRecorderListener(MVYAudioRecorderListener audioRecorderListener) {
